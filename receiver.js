(function () {
  ...
  function renderCurrent() {
    ...
    var letter;
    byId('current').textContent = (n === null || typeof n === 'undefined') ? '—' : String(n);
    if (state.mode === 75 && n !== null && typeof n !== 'undefined') {
      ...
      byId('current-label').textContent = (n === null || typeof n === 'undefined') ? '—' : String(n);
  ...
  function renderStatus() {
    ...
    byId('countdown').textContent = (state.autoDrawEnabled && !state.autoPaused && !state.gameEnded)
